...
ggsave(p.motifs.pos, filename = "/home/vincent.hahaut/data_storage/FS_intermediate_file/FIGURES/UMIposition.tiff", width = 10, height = 13, dpi = 450)
```
...
ggsave(p.cover, filename = paste0("/home/vincent.hahaut/data_storage/FS_intermediate_file/FIGURES/UMIinR2.Coverage.tiff"), bg = "white", dpi = 450, height = 6, width = 12)
```
...
p.star <- ggplot() +
  ...
  ggpubr::stat_pvalue_manual(p.signif, label = "p = {p.adj.signif}",  tip.length = 0.01, step.increase = 0.04, size = 4) + ggtitle("FS-UMI CTAAC")
...
ggsave(p.star, filename = "/home/vincent.hahaut/data_storage/FS_intermediate_file/FIGURES/UMIinR2.star.stats.tiff", dpi = 450, bg = "white", width = 12, height = 5)
```
...
ggsave(p.readDistrib.all, filename = "/home/vincent.hahaut/data_storage/FS_intermediate_file/FIGURES/UMIinR2.resqc.stats.tiff", dpi = 450, bg = "white", width = 16, height = 5)
...
p.signif <- med %>% 
  filter(GROUP == "FS-UMI\nCTAAC\nRetinal Organoids") %>%
  group_by(threshold) %>%
  rstatix::wilcox_test(counts~TYPE) %>%
  filter(p < 0.05) %>% 
  rstatix::add_y_position(fun = "max", scales = "free") %>%
  mutate(p.adj.signif = formatC(p, format = "e", digits = 2))
...
ggsave(p.counts.umi, filename = "/home/vincent.hahaut/data_storage/FS_intermediate_file/FIGURES/UMIinR2.counts.tiff", dpi = 450, bg = "white", width = 8, height = 5)
...
ggsave(p.corrs, filename = "/home/vincent.hahaut/data_storage/FS_intermediate_file/FIGURES/UMIinR2.corrs.tiff", dpi = 450, bg = "white", width = 3, height = 5)
...
ggsave(percentageUMI, filename="/home/vincent.hahaut/data_storage/FS_intermediate_file/FIGURES/ORGANOIDS_percentageUMI.tiff", bg = "white", dpi = 450, width = 12, height = 5)
...
ggsave(p.dups, filename="/home/vincent.hahaut/data_storage/FS_intermediate_file/FIGURES/ORGANOIDS_percentageDups.tiff", bg = "white", dpi = 450, width = 6, height = 5)
```
