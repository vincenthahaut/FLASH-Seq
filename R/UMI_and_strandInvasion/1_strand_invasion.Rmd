...
invasion.plot <- function(group, suffix = "group1"){
  ...
  ggsave(p.all, filename = paste0("/home/vincent.hahaut/data_storage/FS_intermediate_file/FIGURES/StrandInvasion_Mismatch.", suffix,".tiff"), dpi= 450, width = 10, height = 5)
  ggsave(p.all.GGG, filename = paste0("/home/vincent.hahaut/data_storage/FS_intermediate_file/FIGURES/StrandInvasion_Mismatch.", suffix,".GGG.tiff"), dpi= 450, width = 10, height = 5)
...
invasion.plot(group = group5, suffix = "group5")
