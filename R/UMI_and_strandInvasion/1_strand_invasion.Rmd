...
invasion.plot <- function(group, suffix = "group1"){
  ...
  ggsave(p.all, filename = paste0("/home/vincent.hahaut/data_storage/FS_intermediate_file/FIGURES/StrandInvasion_Mismatch.", suffix,".pdf"), dpi= 450, width = 14, height = 5.5)
  ggsave(p.all.GGG, filename = paste0("/home/vincent.hahaut/data_storage/FS_intermediate_file/FIGURES/StrandInvasion_Mismatch.", suffix,".GGG.pdf"), dpi= 450, width = 14, height = 5.5)
