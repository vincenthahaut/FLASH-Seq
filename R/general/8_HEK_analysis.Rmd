...
# 2.3. Save results
ggsave(p1.500K, 
       filename = "/home/vincent.hahaut/data_storage/FS_intermediate_file/FIGURES/HEK_exonCounts.tiff", bg = "white", dpi = 450, width = 7, height = 6)
...
ggsave(p.intron.hek, 
       filename = "/home/vincent.hahaut/data_storage/FS_intermediate_file/FIGURES/HEK_introns.tiff", bg = "white", dpi = 450, height = 6, width = 10)
...
ggsave(p2, 
       filename = "/home/vincent.hahaut/data_storage/FS_intermediate_file/FIGURES/HEK_exonCounts.downsampling.tiff", bg = "white", dpi = 450, width = 10, height = 6)
...
p.diversity <- ggplot() +
  ...
  xlab("") +
  scale_y_continuous(breaks = seq(11000,13500,1000)) +
  ylab("Gene Diversity") +
  scale_fill_manual(values = c("FS - 25 µL" = "#E41A1C",
                               "SS2" = "#377EB8",
                               "FS - 5 µL" = "#FF850D",
                               "SS3" = "#4DAF4A",
                               "SSsc" = "#984EA3")) 
ggsave(p.diversity, filename = "/home/vincent.hahaut/data_storage/FS_intermediate_file/FIGURES/HEK_diversity.tiff", width = 6, height = 6, dpi= 450, bg = "white")
...
ggsave(p.gene.content, filename = paste0("/home/vincent.hahaut/data_storage/FS_intermediate_file/FIGURES/HEK_geneContent.tiff"), dpi = 450, height = 16, width = 12)
...
ggsave(p.cover, filename = paste0("/home/vincent.hahaut/data_storage/FS_intermediate_file/FIGURES/HEK_geneBodyCoverage.tiff"), bg = "white", dpi = 450, height = 6, width = 8)
...
ggsave(plot_grid(align = "v", p.GC + theme(legend.position = "none"), p.Length  + theme(legend.position = "none"), nrow = 2), filename = "/home/vincent.hahaut/data_storage/FS_intermediate_file/FIGURES/HEK_DE_explore.tiff", dpi = 450, height = 12, width = 6, bg = "white")
...
p.isoform.HEK <- ggplot() +
  ...
  scale_fill_manual(values = c("FS - 25 µL" = "#E41A1C",
                               ...
                               "FS - 5 µL" = "#FF850D",
                               "SS3" = "#4DAF4A"))
ggsave(p.isoform.HEK, filename = "/home/vincent.hahaut/data_storage/FS_intermediate_file/FIGURES/HEK_isoforms.tiff", dpi = 450, width = 10, height = 8, bg = "white")
...
ggsave(saturation, filename = "/home/vincent.hahaut/data_storage/FS_intermediate_file/FIGURES/HEK_saturation.tiff", dpi = 450, height = 6, width = 16, bg = "white")

ggsave(plot_grid(p2, saturation, nrow = 2), filename = "/home/vincent.hahaut/data_storage/FS_intermediate_file/FIGURES/HEK_saturation_downsampling.tiff", dpi = 500, height = 10, width = 11, bg = "white")
...
# 2.3. Save results
ggsave(p1.500K, 
       filename = "/home/vincent.hahaut/data_storage/FS_intermediate_file/FIGURES/HEK_exonCounts_mini.tiff", bg = "white", dpi = 450, width = 7, height = 6)
```
...
ggsave(pA, filename = "/home/vincent.hahaut/data_storage/FS_intermediate_file/FIGURES/HEK_cDNA_yield.tiff", bg = "white", dpi = 450, height = 8, width = 6)
...
ggsave(p6, 
       filename = "/home/vincent.hahaut/data_storage/FS_intermediate_file/FIGURES/HEK_kendallCorr.tiff", bg = "white", dpi = 450, width = 5, height = 6)
```
...
ggsave(p1, 
       filename = "/home/vincent.hahaut/data_storage/FS_intermediate_file/FIGURES/HEK_lowAmplificationCycles.reviewer.tiff", bg = "white", dpi = 450, width = 12, height = 6)
...
ggsave(p.cover, filename = paste0("/home/vincent.hahaut/data_storage/FS_intermediate_file/FIGURES/HEK_LOWAMP_COVERAGE.tiff"), dpi = 450, height = 8, bg = "white", width = 12)
...
ggsave(p2, bg = "white",
       filename = "/home/vincent.hahaut/data_storage/FS_intermediate_file/FIGURES/HEK_lowAmplificationCycles_RESQC.tiff", dpi = 450, width = 12, height = 6)
...
ggsave(p3, 
       filename = "/home/vincent.hahaut/data_storage/FS_intermediate_file/FIGURES/HEK_lowAmplificationCycles_STAR.tiff", bg = "white", dpi = 450, width =  8, height = 6)

ggsave(plot_grid(p2, p3, nrow = 2), bg = "white",
       filename = "/home/vincent.hahaut/data_storage/FS_intermediate_file/FIGURES/HEK_lowAmplificationCycles_STAR_COMBINED.tiff", dpi = 450, width = 8, height = 10)
...
ggsave(p6, 
       filename = "/home/vincent.hahaut/data_storage/FS_intermediate_file/FIGURES/HEK_LA_kendallCorr.tiff", bg = "white", dpi = 450, width = 6, height = 8)
```
