...
featurecounts.exon.down <- read_rds(file = paste0("/home/vincent.hahaut/data_storage/FS_intermediate_file/FS_ORGANOIDS_featureCounts.exons.internal.33800.2021-12-11.rds"))
...
umi.exon.down <- read_rds(file = paste0("/home/vincent.hahaut/data_storage/FS_intermediate_file/FS_ORGANOIDS_umiCounts.exons.33800.2021-12-11.rds.bz"))
...
ggsave(p.dimplot.celltype, filename = "/home/vincent.hahaut/data_storage/ORGANOIDS/FIGURES/ORGANOIDS_dimplot.celltype.pdf", bg = "white", dpi = 450, height = 18, width = 6)
...
ggsave(DimPlot(ssce.FS.all, group.by = "cell_type", pt.size = 1.25) + scale_color_manual(values = celltype.colors()), dpi = 450, width = 12, height = 8, bg = "white",
       file = "/home/vincent.hahaut/data_storage/ORGANOIDS/FIGURES/ORGANOIDS_dimplot.ALL.celltype.pdf")
...
ggsave(DimPlot(ssce.FS.all, group.by = "cell_type", pt.size = 1.25) + scale_color_manual(values = celltype.colors()) + theme_void() + theme(legend.position = "none"), dpi = 450, width = 12, height = 8, bg = "white",
       file = "/home/vincent.hahaut/data_storage/ORGANOIDS/FIGURES/ORGANOIDS_dimplot.ALL.celltype.void.pdf")
...
ggsave(DimPlot(ssce.10x, group.by = "cell_type", pt.size = 1.25) + scale_color_manual(values = celltype.colors()) + theme_void() + theme(legend.position = "none"), dpi = 450, width = 12, height = 8, bg = "white",
       file = "/home/vincent.hahaut/data_storage/ORGANOIDS/FIGURES/ORGANOIDS_dimplot.10x.celltype.void.pdf")


p <- ssce.FS.all[["umap"]]@cell.embeddings %>%
  as_tibble() %>%
  mutate(GROUP = ssce.FS.all$cell_type) %>%
...
ggsave(p.celltypes, bg = "white", filename = "/home/vincent.hahaut/data_storage/ORGANOIDS/FIGURES/ORGANOIDS_cell_types.perc.pdf", dpi = 450, height = 10, width = 7)
```
...
ggsave(p.dotplot, dpi = 450, width = 12, height = 12, bg = "white",
       file = "/home/vincent.hahaut/data_storage/ORGANOIDS/FIGURES/ORGANOIDS_UMI.dotplot.pdf")
...
ggsave(p.dotplot, dpi = 450, width = 12, height = 12, bg = "white",
       file = "/home/vincent.hahaut/data_storage/ORGANOIDS/FIGURES/ORGANOIDS_INTERNAL.dotplot.pdf")
...
ggsave(p.dotplot, dpi = 450, width = 12, height = 12, bg = "white",
       file = "/home/vincent.hahaut/data_storage/ORGANOIDS/FIGURES/ORGANOIDS_ALL.dotplot.pdf")


p.dotplot <- DotPlot(object = ssce.10x, features = unique(c(
  # "Photoreceptor/Bipolar Fate"
  "OTX2", "PRDM1", "RXRG", "NEUROD1", "NEUROD4",
  # "Rod Fate"
  "NEUROD1", "CRX",
...
ggsave(p.dotplot, dpi = 450, width = 12, height = 12, bg = "white",
       file = "/home/vincent.hahaut/data_storage/ORGANOIDS/FIGURES/ORGANOIDS_10x.dotplot.pdf")
...
ggsave(p.logFcRelation, filename = "/home/vincent.hahaut/data_storage/ORGANOIDS/FIGURES/ORGANOIDS_pLogFC.pdf", dpi = 450, height = 6, width = 8, bg= "white")
...
ggsave(p.logFold.distrib, filename = "/home/vincent.hahaut/data_storage/ORGANOIDS/FIGURES/logFold.distribution.pdf", dpi = 450, height = 4, width = 6, bg = "white")
...
tiff(filename = paste0("/home/vincent.hahaut/data_storage/ORGANOIDS/FIGURES/UpsteR.photobipolarFate.pdf"), width = 3600, height = 2400, res = 450,bg = "white")
uu.l[[1]]
dev.off()
tiff(filename = paste0("/home/vincent.hahaut/data_storage/ORGANOIDS/FIGURES/UpsteR.", names(uu.l)[2], ".pdf"), width = 3600, height = 2400, res = 450,bg = "white")
uu.l[[2]]
dev.off()
tiff(filename = paste0("/home/vincent.hahaut/data_storage/ORGANOIDS/FIGURES/UpsteR.", names(uu.l)[3], ".pdf"), width = 3600, height = 2400, res = 450, bg = "white")
uu.l[[3]]
dev.off()
tiff(filename = paste0("/home/vincent.hahaut/data_storage/ORGANOIDS/FIGURES/UpsteR.", names(uu.l)[4], ".pdf"), width = 3600, height = 2400, res = 450, bg = "white")
uu.l[[4]]
dev.off()
tiff(filename = paste0("/home/vincent.hahaut/data_storage/ORGANOIDS/FIGURES/UpsteR.", names(uu.l)[5], ".pdf"), width = 3600, height = 2400, res = 450,bg = "white")
uu.l[[5]]
dev.off()
tiff(filename = paste0("/home/vincent.hahaut/data_storage/ORGANOIDS/FIGURES/UpsteR.", names(uu.l)[6], ".pdf"), width = 3600, height = 2400, res = 450,bg = "white")
uu.l[[6]]
dev.off()
tiff(filename = paste0("/home/vincent.hahaut/data_storage/ORGANOIDS/FIGURES/UpsteR.", names(uu.l)[7], ".pdf"), width = 3600, height = 2400, res = 450,bg = "white")
uu.l[[7]]
dev.off()
tiff(filename = paste0("/home/vincent.hahaut/data_storage/ORGANOIDS/FIGURES/UpsteR.", names(uu.l)[8], ".pdf"), width = 3600, height = 2400, res = 350,bg = "white")
uu.l[[8]]
dev.off()
tiff(filename = paste0("/home/vincent.hahaut/data_storage/ORGANOIDS/FIGURES/UpsteR.horizamacrineFate.pdf"), width = 3600, height = 2400, res = 450,bg = "white")
uu.l[[9]]
dev.off()
tiff(filename = paste0("/home/vincent.hahaut/data_storage/ORGANOIDS/FIGURES/UpsteR.", names(uu.l)[10], ".pdf"), width = 3600, height = 2400, res = 450,bg = "white")
uu.l[[10]]
dev.off()
tiff(filename = paste0("/home/vincent.hahaut/data_storage/ORGANOIDS/FIGURES/UpsteR.", names(uu.l)[11], ".pdf"), width = 3000, height = 2400 ,res = 450, bg = "white")
uu.l[[11]]
dev.off()
...
ggsave(filename = paste0("/home/vincent.hahaut/data_storage/ORGANOIDS/FIGURES/Gene_features.pdf"),
  p.overlap,
...
p.diversity <- res %>%
    ...
    scale_fill_manual(values = c("FS - all reads" = "#FF850D", 
                                 "10x Genomics" = "#2ac7c2")) +
    scale_y_continuous(labels = c("0K", "2.5K", "5K", "7.5K", "10K")) +
    coord_flip() +
    theme_cowplot(font_size = 20) +
    theme(panel.border = element_rect(size = 0.5, color = "black"), axis.title.x = element_text(size = 18), axis.text.x = element_text(size = 18), strip.background = element_blank(), strip.text = element_blank(), legend.position = "bottom", legend.direction = "horizontal", legend.title = element_blank(), axis.ticks.y = element_blank()) +
...
ggsave(p.diversity, filename = "/home/vincent.hahaut/data_storage/ORGANOIDS/FIGURES/ORGANOIDS_diversity.pdf",
       dpi = 450, width = 6, height = 8, bg = "white")
...
p.diversity <- res %>%
  ...
  ggpubr::stat_pvalue_manual(p.signif, label = "p = {p.adj.signif}", step.increase = 0.065, step.group.by = "cell_type", tip.length = 0.01, size = 5) +
  scale_y_continuous(seq(2000,8000,2000), labels = c("2,000", "4,000", "6,000", "8,000"), limits = c(0,8500), name = "Gene Diversity") + 
  scale_fill_manual(values = c("UMI" = "#E7298A", 
                               "INTERNAL" = "#7570B3",
                               "DROPLET" = "#2ac7c2")) +
...
ggsave(p.diversity, filename = "/home/vincent.hahaut/data_storage/ORGANOIDS/FIGURES/ORGANOIDS_diversity.downsample.pdf",
       dpi = 450, width = 18, height = 10, bg = "white")
...
p.detected <- df %>%
  ...
  ggpubr::stat_pvalue_manual(p.signif, label = "p = {p.adj.signif}", step.increase = 0.04, step.group.by = "cell_type", tip.length = 0.01, size = 5) +
  scale_fill_manual(values = c("UMI" = "#E7298A", 
                               "INTERNAL" = "#7570B3",
                               "DROPLET" = "#2ac7c2")) +
  facet_wrap("cell_type", scales = "free_x", nrow = 2) +
  scale_y_continuous(breaks = seq(0,8000,2000), labels = c("0", "2,000", "4,000", "6,000", "8,000"), limits = c(0,8500)) + 
  theme_bw(base_size = 20) +
...
ggsave(p.detected, filename = "/home/vincent.hahaut/data_storage/ORGANOIDS/FIGURES/ORGANOIDS_detected.downsample.pdf",
       dpi = 450, width = 16, height = 10, bg = "white")

ggsave(plot_grid(p.diversity + ylab("Gene Diversity")  + theme(legend.position = "none"), 
                 p.detected + ylab("Genes Detected") + theme(legend.position = "none"), nrow = 2), filename = "/home/vincent.hahaut/data_storage/ORGANOIDS/FIGURES/ORGANOIDS_detected_diversity.downsample.pdf",
       dpi = 450, width = 16, height = 10, bg = "white")

```

```{r gene diversity - matching depth - poster, eval = FALSE, echo = F, include = F, warning = FALSE, comment = F, message = F, cache = FALSE}
...
ssce.FS.all.tmp <- ssce.FS.all[,ssce.FS.all$cell_type %in% c("Rods", "Müller Cells")]
ssce.10x.tmp <- ssce.10x[,ssce.10x$cell_type %in% c("Rods", "Müller Cells")]

# 2. Resample 10 cells 100 times in each cell type (10x / FS-UMI)
# Get the number of genes detected in >2 cells
set.seed(42)
res <- data_frame()
for(i in unique(ssce.FS.all.tmp$cell_type)){
  print(i)
  
  index <- colnames(ssce.FS.all.tmp)[ssce.FS.all.tmp$cell_type == i]
  if(any(ssce.10x$cell_type %in% i) & any(ssce.FS.all.tmp$cell_type %in% i)){
    ssce.10x.tmp <- ssce.10x[,ssce.10x$cell_type == i]
    c.ssce.FS.all.tmp <- ssce.FS.all.tmp[,colnames(ssce.FS.all.tmp) %in% index]

    for(j in 1:100){
        print(paste0(i, " : ", j))
        set.seed(j)
        index.1 <- sample(1:ncol(ssce.10x.tmp), size = 10, replace = FALSE)
        index.2 <- sample(1:ncol(c.ssce.FS.all.tmp), size = 10, replace = FALSE)

        sce.1 <- ssce.10x.tmp[,index.1]
        sce.2 <- c.ssce.FS.all.tmp[,index.2]
        ...
        res <- bind_rows(res,
                  data_frame(
                    ...
                    cell_type = i,
                    DROPLET = sum(rowSums(GetAssayData(sce.1, "counts") > 0) > 2),
                    ALL = sum(rowSums(GetAssayData(sce.2, "counts") > 0) > 2))
        )
      }
    }
  }
...
# 3. Aggregate results
res <- res %>%
  pivot_longer(cols = c("ALL", "DROPLET")) 


# 4. Dunn's test
p.signif.diversity <- res %>%
  group_by(cell_type) %>%
  rstatix::dunn_test(value ~ name) %>%
  rstatix::add_y_position(fun = "max") %>%
  filter(group1 == "DROPLET") %>%
...
p.diversity <- res %>%
  ...
  geom_violin(aes(x = name, fill = name, y = value)) +
  geom_boxplot(aes(x = name, fill = name, y = value), width = 0.1, position = position_dodge(width = 0.9)) +
  scale_y_continuous(seq(2000,8000,2000), labels = c("2,000", "4,000", "6,000", "8,000"), limits = c(0,9000), name = "Gene Diversity") + 
  scale_fill_manual(values = c("ALL" = "#E41A1C",
                               "DROPLET" = "#2ac7c2")) +
  facet_wrap("cell_type", scales = "free_x", nrow = 2) +
  theme_bw(base_size = 20) +
  ylab("Gene Diversity") + xlab("") +
...
## Gene counts
df <- bind_rows(
  data_frame(count_0 = ssce.10x.tmp$nFeature_RNA,
           cell_type = ssce.10x.tmp$cell_type,
           TYPE = "DROPLET"),
  data_frame(count_0 = ssce.FS.all.tmp$nFeature_RNA,
             cell_type = ssce.FS.all.tmp$cell_type,
             TYPE = "ALL")) 


p.signif.detected <- df %>%
  group_by(cell_type) %>%
  rstatix::dunn_test(count_0 ~ TYPE) %>%
  rstatix::add_y_position(fun = "max") %>%
  filter(group1 == "DROPLET") %>%
...
p.detected <- df %>%
  ...
  scale_fill_manual(values = c("ALL" = "#E41A1C",
                               "DROPLET" = "#2ac7c2")) +
  facet_wrap("cell_type", scales = "free_x", nrow = 2) +
  scale_y_continuous(breaks = seq(0,8000,2000), labels = c("0", "2,000", "4,000", "6,000", "8,000"), limits = c(0,9000)) + 
  theme_bw(base_size = 20) +
  ylab("Gene Detected") + xlab("") +
  theme(legend.position = "none", 
        legend.title = element_blank(), 
...
ggsave(plot_grid(p.detected, p.diversity, ncol = 2), filename = "/home/vincent.hahaut/data_storage/ORGANOIDS/FIGURES/ORGANOIDS_diversity.downsample.poster.tiff",
...
med.salmon <- data_frame(ID = colnames(salmon.all),
                      count_0.salmon = colSums(SummarizedExperiment::assay(salmon.all, "abundance") > 0), 
                      count_1.salmon = colSums(SummarizedExperiment::assay(salmon.all, "abundance") > 1), 
                      count_5.salmon = colSums(SummarizedExperiment::assay(salmon.all, "abundance") > 5))
...
ggsave(p.proportion, dpi = 450, height = 6, width = 6, bg = "white",
       filename = "/home/vincent.hahaut/data_storage/ORGANOIDS/FIGURES/ORGANOIDS_proportions.pdf")
...
p.gene.per.cell <- 
  ...
  ggpubr::stat_pvalue_manual(p.signif, label = "p = {p.adj.signif}", step.increase = 0.025, step.group.by = "cell_type.internal", tip.length = 0.01, size = 5) +
...
# 8. Save
ggsave(p.gene.per.cell, dpi = 450, height = 10, width = 18, bg = "white",
       filename = "/home/vincent.hahaut/data_storage/ORGANOIDS/FIGURES/ORGANOIDS_totalGenes.pdf")
...
ggsave(p.transcripts.per.cell, dpi = 450, width = 16, height = 10, bg = "white",
       filename = "/home/vincent.hahaut/data_storage/ORGANOIDS/FIGURES/ORGANOIDS_totalTranscripts.pdf")
...
write_rds(ssce, "/home/vincent.hahaut/data_storage/transfer/Mendeley/Retinal Organoids/FLASH-Seq/Count Matrix/FS_w18organoids_allReads_isoforms_salmon_prefiltered_unprocessed.rds")
...
ggsave(DimPlot(ssce, group.by = "cell_type") + scale_color_manual(values = celltype.colors()), bg = "white",
  dpi = 450, width = 10, height = 6, filename = "/home/vincent.hahaut/data_storage/ORGANOIDS/FIGURES/DimPlot.transcriptome.pdf")
...
ggsave(p.isoforms, filename = "/home/vincent.hahaut/data_storage/ORGANOIDS/FIGURES/Isoforms.pdf", dpi = 200, height = 6, width = 10, bg = "white")
```
...
ggsave(p.exon, filename = "/home/vincent.hahaut/data_storage/ORGANOIDS/FIGURES/ORGANOIDS_PKM_exons.pdf", dpi = 450, height = 12, width = 8, bg = "white")
...
ggsave(FeaturePlot(ssce, features = PKM, ncol = 2) & scale_color_viridis_c(), 
       filename =  "/home/vincent.hahaut/data_storage/ORGANOIDS/FIGURES/PKM.featurePlot.pdf", dpi = 200, height = 12, width = 8)
...
ggsave(
  plot_grid(p.internal, p.umi, p.isoforms, nrow = 3), filename = "/home/vincent.hahaut/data_storage/ORGANOIDS/FIGURES/downsampling.pdf", 
...
mycors <- sapply(c("5000","10000","20000","40000","50000","75000","100000","125000","150000","200000"), function(x)
  pcaPP::cor.fk(filter(umi_internal, DEPTH == x, internal >0 & umi>0)$internal, filter(umi_internal, DEPTH == x, internal >0 & umi>0)$umi))
  
mycors2 <- sapply(c("5000","10000","20000","40000","50000","75000","100000","125000","150000","200000"), function(x)
  broom::tidy(cor.test(method = "pearson", filter(umi_internal, DEPTH == x, internal >0 & umi>0)$internal, filter(umi_internal, DEPTH == x, internal >0 & umi>0)$umi)$estimate))
...
ggsave(z, filename = "/home/vincent.hahaut/data_storage/ORGANOIDS/FIGURES/correlation_umi_internal.pdf", bg = "white", dpi = 450, height = 7, width = 14)
...
write_rds(ssce.FS.umi, "/home/vincent.hahaut/data_storage/transfer/Mendeley/Retinal Organoids/FLASH-Seq/Count Matrix/FS_w18organoids_umiReads.rds")
write_rds(ssce.FS.internal, "/home/vincent.hahaut/data_storage/transfer/Mendeley/Retinal Organoids/FLASH-Seq/Count Matrix/FS_w18organoids_internalReads.ds")
write_rds(ssce.FS.all, "/home/vincent.hahaut/data_storage/transfer/Mendeley/Retinal Organoids/FLASH-Seq/Count Matrix/FS_w18organoids_allReads.ds")
