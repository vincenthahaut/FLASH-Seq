...
med.salmon <- data_frame(ID = colnames(salmon.all),
                      count_0.salmon = colSums(SingleCellExperiment::assay(salmon.all, "abundance") > 0), 
                      count_1.salmon = colSums(SingleCellExperiment::assay(salmon.all, "abundance") > 1), 
                      count_5.salmon = colSums(SingleCellExperiment::assay(salmon.all, "abundance") > 5))
