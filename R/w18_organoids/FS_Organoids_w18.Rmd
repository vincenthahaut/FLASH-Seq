...
p.diversity <- res %>%
  ...
  theme(axis.text.y = element_blank(),legend.position = "none", legend.title = element_blank(), axis.ticks.y = element_blank()) +
...
ggsave(plot_grid(p.diversity, p.detected, nrow = 2), filename = "/home/vincent.hahaut/data_storage/ORGANOIDS/FIGURES/ORGANOIDS_detected_diversity.downsample.tiff",
       dpi = 450, width = 20, height = 14, bg = "white")
